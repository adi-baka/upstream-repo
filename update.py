...
if len(UPSTREAM_REPO) == 0:
    UPSTREAM_REPO = 'https://ACE-MLTB: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@github.com/ACE-MLTB/ACE-Heroku'
...
update = srun([f"git init -q \
                    && git config --global user.email atulk5137@gmail.com \
                    && git config --global user.name TheFlashSpeedster \
                    && git add . \
...
if update.returncode == 0:
    ...
    log_info('Thanks For Using @ACE_ML')
else:
