...
rawowners = "<h1 style='text-align: center'><a href='https://telegram.me/ACE_ML'>Join @ACE_ML On Telegram</h1>"
...
files_list = '''
    <div id="sticks">
        <h4>📂 Files: <b id="checked_files">0</b> of <b id="total_files">0</b></h4>
        <h4>💾 Size: <b id="checked_size">0</b> of <b id="total_size">0</b></h4>
    </div>
    <section>
...
<head>
    ...
    <link rel="icon" href="https://graph.org/file/c36b781f813cb5c881377.png" type="image/jpg">
...
<body>
    ...
    <header>
        <div class="brand">
            <img src="https://graph.org/file/c36b781f813cb5c881377.png" alt="logo" />
        </div>
        <h2 class="name">Torrent Selection</h2>
        <div class="social">
            <a href="https://cosmofeed.com/FlashSpeedster"><i class="fas fa-donate"></i></a>
            <a href="https://telegram.me/ACE_ML"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
